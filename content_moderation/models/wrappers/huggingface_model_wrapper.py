...
from content_moderation.models.helpers import T5ForTextToText
from content_moderation.models.tokenizers import T5Tokenizer
...
class HuggingFaceModelWrapper(PyTorchModelWrapper):
    ...
    def get_grad(self, text_input):
        ...
        """
        if isinstance(self.model, content_moderation.models.helpers.T5ForTextToText):
