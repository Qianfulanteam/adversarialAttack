...
from content_moderation.model_args import TEXTATTACK_MODELS
from content_moderation.models.helpers import GloveEmbeddingLayer
from content_moderation.models.helpers.utils import load_cached_state_dict
from content_moderation.shared import utils
...
class WordCNNForClassification(nn.Module):
    ...
    def __init__(
        ...
        self.tokenizer = content_moderation.models.tokenizers.GloveTokenizer(
