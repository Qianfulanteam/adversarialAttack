...
TEXTATTACK_DATASET_BY_MODEL = {
    ...
    #
    "t5-en-de": (
        "content_moderation.datasets.helpers.TedMultiTranslationDataset",
        "en",
        "de",
    ),
    "t5-en-fr": (
...
class DatasetArgs:
    ...
    def _create_dataset_from_args(cls, args):
        ...
        ``content_moderation.dataset.Dataset`` object."""
        ...
        if args.dataset_by_model in HUGGINGFACE_DATASET_BY_MODEL:
            ...
            if dataset[0].startswith("textattack"):
                ...
                # ex: dataset = ('content_moderation.datasets.helpers.TedMultiTranslationDataset', 'en', 'de')
        ...
        if args.dataset_from_file:
            ...
            if args.dataset_split:
                if len(dataset_args) > 1:
                    ...
                    dataset = content_moderation.datasets_.HuggingFaceDataset(
        ...
        ), "Loaded `dataset` must be of type `content_moderation.datasets.Dataset`."
