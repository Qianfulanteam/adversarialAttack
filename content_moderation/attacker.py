...
class Attacker:
    ...
    def __init__(self, attack, dataset, attack_args=None):
        ...
        assert isinstance(
            dataset, content_moderation.datasets_.Dataset
    ...
    def _attack(self):
        ...
        while worklist:
            ...
            try:
                ...
                continue
            example = content_moderation.shared.AttackedText(example)
            ...
            if (
                ...
                new_checkpoint = content_moderation.shared.AttackCheckpoint(
                    self.attack_args,
    ...
    def attack_dataset(self):
        ...
        content_moderation.shared.utils.set_seed(self.attack_args.random_seed)
    ...
    def from_checkpoint(cls, attack, dataset, checkpoint):
        ...
        """
        assert isinstance(
            checkpoint, (str, content_moderation.shared.AttackCheckpoint)
        ), f"`checkpoint` must be of type `str` or `textattack.shared.AttackCheckpoint`, but got type `{type(checkpoint)}`."

        if isinstance(checkpoint, str):
            checkpoint = content_moderation.shared.AttackCheckpoint.load(checkpoint)
    ...
    def attack_interactive(attack):
        ...
        while True:
            ...
            example = content_moderation.shared.attacked_text.AttackedText(text)
...
def attack_from_queue(
    ...
    content_moderation.shared.utils.set_seed(attack_args.random_seed)
