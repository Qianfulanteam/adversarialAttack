...
from content_moderation.shared import logger, utils
...
class AttackCheckpoint:
    ...
    def __init__(
        ...
        assert isinstance(
            attack_args, content_moderation.AttackArgs
        ), "`attack_args` must be of type `textattack.AttackArgs`."
        assert isinstance(
            attack_log_manager, content_moderation.loggers.AttackLogManager
