...
from content_moderation.attack_results import FailedAttackResult, SkippedAttackResult
from content_moderation.metrics import Metric
import content_moderation.shared.utils
...
class Perplexity(Metric):
    def __init__(self, model_name="gpt2"):
        ...
        if model_name == "gpt2":
            ...
            self.ppl_model.to(content_moderation.shared.utils.device)
        ...
        with torch.no_grad():
            ...
            for i in range(0, input_ids.size(1), self.stride):
                ...
                input_ids_t = input_ids[:, begin_loc:end_loc].to(
                    content_moderation.shared.utils.device
                )
