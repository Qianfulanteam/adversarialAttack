...
from content_moderation.constraints.semantics.sentence_encoders import UniversalSentenceEncoder
...
class SwapAugmenter(Augmenter):
    def __init__(self, **kwargs):
        from content_moderation.transformations import WordInnerSwapRandom
...
class SynonymInsertionAugmenter(Augmenter):
    def __init__(self, **kwargs):
        from content_moderation.transformations import WordInsertionRandomSynonym
...
class WordNetAugmenter(Augmenter):
    ...
    def __init__(self, **kwargs):
        from content_moderation.transformations import WordSwapWordNet
...
class DeletionAugmenter(Augmenter):
    def __init__(self, **kwargs):
        from content_moderation.transformations import WordDeletion
...
class EmbeddingAugmenter(Augmenter):
    ...
    def __init__(self, **kwargs):
        ...
        from content_moderation.constraints.semantics import WordEmbeddingDistance
...
class BackTranslationAugmenter(Augmenter):
    ...
    def __init__(self, **kwargs):
        from content_moderation.transformations.sentence_transformations import BackTranslation
...
class BackTranscriptionAugmenter(Augmenter):
    ...
    def __init__(self, **kwargs):
        from content_moderation.transformations.sentence_transformations import (
            BackTranscription,
        )
