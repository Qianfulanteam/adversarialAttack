...
from content_moderation.datasets_ import HuggingFaceDataset
from content_moderation.models.helpers import LSTMForClassification, WordCNNForClassification
from content_moderation.models.wrappers import (
    HuggingFaceModelWrapper,
    ModelWrapper,
    PyTorchModelWrapper,
)
from content_moderation.shared import logger
from content_moderation.shared.utils import ARGS_SPLIT_TOKEN
...
class _CommandLineTrainingArgs:
    ...
    def _create_attack_from_args(cls, args, model_wrapper):
        import content_moderation  # noqa: F401
