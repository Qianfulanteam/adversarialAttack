...
from content_moderation.shared.utils import ARGS_SPLIT_TOKEN, load_module_from_file
...
ATTACK_RECIPE_NAMES = {
    "alzantot": "content_moderation.attack_recipes.GeneticAlgorithmAlzantot2018",
    "bae": "content_moderation.attack_recipes.BAEGarg2019",
    "bert-attack": "content_moderation.attack_recipes.BERTAttackLi2020",
    "faster-alzantot": "content_moderation.attack_recipes.FasterGeneticAlgorithmJia2019",
    "deepwordbug": "content_moderation.attack_recipes.DeepWordBugGao2018",
    "hotflip": "content_moderation.attack_recipes.HotFlipEbrahimi2017",
    "input-reduction": "content_moderation.attack_recipes.InputReductionFeng2018",
    "kuleshov": "content_moderation.attack_recipes.Kuleshov2017",
    "morpheus": "content_moderation.attack_recipes.MorpheusTan2020",
    "seq2sick": "content_moderation.attack_recipes.Seq2SickCheng2018BlackBox",
    "textbugger": "content_moderation.attack_recipes.TextBuggerLi2018",
    "textfooler": "content_moderation.attack_recipes.TextFoolerJin2019",
    "pwws": "content_moderation.attack_recipes.PWWSRen2019",
    "iga": "content_moderation.attack_recipes.IGAWang2019",
    "pruthi": "content_moderation.attack_recipes.Pruthi2019",
    "pso": "content_moderation.attack_recipes.PSOZang2020",
    "checklist": "content_moderation.attack_recipes.CheckList2020",
    "clare": "content_moderation.attack_recipes.CLARE2020",
    "a2t": "content_moderation.attack_recipes.A2TYoo2021",
    "bad-characters": "content_moderation.attack_recipes.BadCharacters2021"
}


BLACK_BOX_TRANSFORMATION_CLASS_NAMES = {
    "random-synonym-insertion": "content_moderation.transformations.RandomSynonymInsertion",
    "word-deletion": "content_moderation.transformations.WordDeletion",
    "word-swap-embedding": "content_moderation.transformations.WordSwapEmbedding",
    "word-swap-homoglyph": "content_moderation.transformations.WordSwapHomoglyphSwap",
    "word-swap-inflections": "content_moderation.transformations.WordSwapInflections",
    "word-swap-neighboring-char-swap": "content_moderation.transformations.WordSwapNeighboringCharacterSwap",
    "word-swap-random-char-deletion": "content_moderation.transformations.WordSwapRandomCharacterDeletion",
    "word-swap-random-char-insertion": "content_moderation.transformations.WordSwapRandomCharacterInsertion",
    "word-swap-random-char-substitution": "content_moderation.transformations.WordSwapRandomCharacterSubstitution",
    "word-swap-wordnet": "content_moderation.transformations.WordSwapWordNet",
    "word-swap-masked-lm": "content_moderation.transformations.WordSwapMaskedLM",
    "word-swap-hownet": "content_moderation.transformations.WordSwapHowNet",
    "word-swap-qwerty": "content_moderation.transformations.WordSwapQWERTY",
    "word-swap-deletions": "content_moderation.transformations.WordSwapDeletions",
    "word-swap-invisible-characters": "content_moderation.transformations.WordSwapInvisibleCharacters",
    "word-swap-reorderings": "content_moderation.transformations.WordSwapReorderings",
    "word-swap-differential-evolution": "content_moderation.transformations.WordSwapDifferentialEvolution",
}


WHITE_BOX_TRANSFORMATION_CLASS_NAMES = {
    "word-swap-gradient": "content_moderation.transformations.WordSwapGradientBased"
}
...
CONSTRAINT_CLASS_NAMES = {
    ...
    #
    "embedding": "content_moderation.constraints.semantics.WordEmbeddingDistance",
    "sbert": "content_moderation.constraints.semantics.sentence_encoders.SBERT",
    "infer-sent": "content_moderation.constraints.semantics.sentence_encoders.InferSent",
    "thought-vector": "content_moderation.constraints.semantics.sentence_encoders.ThoughtVector",
    "use": "content_moderation.constraints.semantics.sentence_encoders.UniversalSentenceEncoder",
    "muse": "content_moderation.constraints.semantics.sentence_encoders.MultilingualUniversalSentenceEncoder",
    "bert-score": "content_moderation.constraints.semantics.BERTScore",
    #
    # Grammaticality constraints
    #
    "lang-tool": "content_moderation.constraints.grammaticality.LanguageTool",
    "part-of-speech": "content_moderation.constraints.grammaticality.PartOfSpeech",
    "goog-lm": "content_moderation.constraints.grammaticality.language_models.GoogleLanguageModel",
    "gpt2": "content_moderation.constraints.grammaticality.language_models.GPT2",
    "learning-to-write": "content_moderation.constraints.grammaticality.language_models.LearningToWriteLanguageModel",
    "cola": "content_moderation.constraints.grammaticality.COLA",
    #
    # Overlap constraints
    #
    "bleu": "content_moderation.constraints.overlap.BLEU",
    "chrf": "content_moderation.constraints.overlap.chrF",
    "edit-distance": "content_moderation.constraints.overlap.LevenshteinEditDistance",
    "meteor": "content_moderation.constraints.overlap.METEOR",
    "max-words-perturbed": "content_moderation.constraints.overlap.MaxWordsPerturbed",
    #
    # Pre-transformation constraints
    #
    "repeat": "content_moderation.constraints.pre_transformation.RepeatModification",
    "stopword": "content_moderation.constraints.pre_transformation.StopwordModification",
    "max-word-index": "content_moderation.constraints.pre_transformation.MaxWordIndexModification",
}


SEARCH_METHOD_CLASS_NAMES = {
    "beam-search": "content_moderation.search_methods.BeamSearch",
    "greedy": "content_moderation.search_methods.GreedySearch",
    "ga-word": "content_moderation.search_methods.GeneticAlgorithm",
    "greedy-word-wir": "content_moderation.search_methods.GreedyWordSwapWIR",
    "pso": "content_moderation.search_methods.ParticleSwarmOptimization",
    "differential-evolution": "content_moderation.search_methods.DifferentialEvolution"
}
...
GOAL_FUNCTION_CLASS_NAMES = {
    ...
    #
    "hardlabel-classification": "content_moderation.goal_functions.classification.HardLabelClassification",
    "targeted-classification": "content_moderation.goal_functions.classification.TargetedClassification",
    "untargeted-classification": "content_moderation.goal_functions.classification.UntargetedClassification",
    "input-reduction": "content_moderation.goal_functions.classification.InputReduction",
    #
    # Text goal functions
    #
    "minimize-bleu": "content_moderation.goal_functions.text.MinimizeBleu",
    "non-overlapping-output": "content_moderation.goal_functions.text.NonOverlappingOutput",
    "text-to-text": "content_moderation.goal_functions.text.TextToTextGoalFunction",
    "maximize-levenshtein": "content_moderation.goal_functions.text.MaximimzeLevenshtein",
    #
    # General goal functions
    #
    "logit-sum": "content_moderation.goal_functions.classification.LogitSum",
    "named-entity-recognition": "content_moderation.goal_functions.NamedEntityRecognition",
    "targeted-strict": "content_moderation.goal_functions.TargetedStrict",
    "targeted-bonus": "content_moderation.goal_functions.TargetedBonus",
}


@dataclass
class AttackArgs:
    """Attack arguments to be passed to :class:`~content_moderation.Attacker`.
    ...
    Args:
        ...
        query_budget (:obj:`int`, `optional`, defaults to :obj:`None`):
            ...
            If not set, we use the query budget set in the :class:`~content_moderation.goal_functions.GoalFunction` object (which by default is :obj:`float("inf")`).
            .. note::
                Setting this overwrites the query budget set in :class:`~content_moderation.goal_functions.GoalFunction` object.
        ...
        log_to_visdom (:obj:`dict`, `optional`, defaults to :obj:`None`):
            If set, Visdom logger is used with the provided dictionary passed as a keyword arguments to :class:`~content_moderation.loggers.VisdomLogger`.
        ...
        log_to_wandb(:obj:`dict`, `optional`, defaults to :obj:`None`):
            If set, WandB logger is used with the provided dictionary passed as a keyword arguments to :class:`~content_moderation.loggers.WeightsAndBiasesLogger`.
            Pass in empty dictionary to use default arguments. For custom logger, the dictionary should have the following
    ...
    def create_loggers_from_args(cls, args):
        ...
        # Create logger
        attack_log_manager = content_moderation.loggers.AttackLogManager(args.metrics)
...
class _CommandLineAttackArgs:
    ...
    def _create_attack_from_args(cls, args, model_wrapper):
        ...
        if args.attack_recipe:
            colored_model_name = content_moderation.shared.utils.color_text(
                args.attack_recipe, color="blue", method="ansi"
            )
            content_moderation.shared.logger.info(
                f"Preparing to start attack: {colored_model_name}"
            )
